...
namespace WinGoMapsX.ViewModel.SettingsView
{
    class SettingsLanguageVM : INotifyPropertyChanged
    {
        ...
        public string APILanguage { get => _apiLanguage; set { _apiLanguage = value; PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("APILanguage")); } }

        public List<KeyValuePair<string, string>> SupportedLanguages
        {
            get => CCHelper.CountriesAndLanguageCodes.ToList();
        }
    ...
    class LanguageSettingsSetters
    {
        ...
        public static void SetOnMapLanguage(string LanguageCode) => ApplicationData.Current.LocalSettings.Values["OnMapLanguage"] = LanguageCode.ToLower();
